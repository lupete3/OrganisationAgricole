    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Note Engagement</li>
        </ol>
        <form action="../access/register_engagement.php" method="POST" enctype="multipart/form-data">
       
        <!-- DataTables Example -->
       <div class="card card-register mx-auto mt-5">
      <div class="card-header text-uppercase">Notre Eggagement</div>
      <div class="card-body">
          ...
          <div class="form-group">
            <div class="form-row">
                 ...
                 <?php 
                   if (isset($_GET['sms']) AND $_GET['sms'] == 2){ ?>
                    <div class="alert alert-success alert-dismissible" id="msg" role="alert">
                            ...
                            <h6>Engagement ajouté avec succès</h6>
                          </div>
              ...
              <div class="col-md-12">
                <input type="text" id="firstName" name="detail" class="form-control" placeholder="Détail Engagement" required="required" autocomplete="off"><br>
              </div>
              
              <div class="col-md-12">
               <br> <button type="submit" name="save" class="btn btn-sm btn-success "><i class="fa fa-check-circle"></i> Enregistrer </button>
          <a href="listEngagement.php" title=""><button type="button" class="btn btn-sm btn-secondary "><i class="fa fa-list"></i> Modifier Engagement</button></a>
              </div>

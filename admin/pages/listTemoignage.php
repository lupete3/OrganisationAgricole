      ...
      <div class="container-fluid">
       ...
       <div class="card mb-3">
          <div class="card-header">
            ...
            Liste des témognages <div class="float-right">
               <a href="gTemoignage.php" class="btn btn-success btn-sm"><i class="fa fa-plus-circle"></i> Ajouter un temoignage</a>
            </div>
          </div>
          <div class="card-body">
              ...
              <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                <thead>
                  <tr>
                    ...
                    <th>Détail de la ville</th>
                    <th>Détail Temoignage</th>
                    <th>Action</th>
                  </tr>
                </thead>
        ...
        <div class="modal-dialog">
          <div class="modal-content panel-primary">
            <div class="modal-header">
              <h4 class="modal-title" id="AddSectionLabel">Modification Temoignage</h4>
              <button type="button" class="close btn " data-dismiss="modal" aria-hidden="true">&times;</button>
                            
            </div>
            <div class="modal-body">
            <form action="../access/edit_temoignage.php" method="post" was-validate>
              <input type="hidden" name="id" id="id" class="form-control" placeholder="Id" required="required" >
              <div class="form-row">
                  <div class="col-md-12">
                    <label for="nom">Nom Partenaire</label>
                    <input type="text" id="nom" name="nom" class="form-control" placeholder="Nom Partenaire" required="required" autofocus="autofocus"> <br>
                  </div>
                  <div class="col-md-12">
                    <label for="nom"> Ville Partenaire</label>
                    <input type="text" id="ville" name="detail" class="form-control" placeholder="Ville Partenaire" required="required" autofocus="autofocus"> <br>
                  </div>
                  <div class="col-md-12">
                    <label for="nom">Témoignage du Partenaire</label>
                    <textarea id="temoignage" name="temoignage" class="form-control" required></textarea>
                     <br>
                  </div>
  ...
  <!-- /.modal-content -->
    ...
    <div class="modal fade" id="supBtn" tabindex="-1" role="dialog" aria-labelledby="Modregister" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content panel-primary">
            <div class="modal-header">
              <h4 class="modal-title" id="AddSectionLabel">Suppression Temoignage</h4>
              <button type="button" class="close btn " data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <form action="../access/edit_temoignage.php" method="post" was-validate>
              ...
              <div class="form-row">
                  ...
                  <div class="col-md-12 text-center">
                    <h5>Voulez-vous vraiment supprimer ce temoignage ?</h5> <br>
                  </div>

       ...
       <div class="card mb-3">
          <div class="card-header">
            ...
            Liste des catégories <div class="float-right">
               <a href="gPartenaire.php" class="btn btn-success btn-sm"><i class="fa fa-plus-circle"></i> Ajouter un nouveau partenaire</a>
            </div>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php 
                    $req=$bd->prepare("SELECT * FROM partenaire ORDER BY entreprise ASC");
                    $req->execute();
                    $i = 1;
                    while ($res = $req->fetch()) { ?>
                  ...
                  <tr style="font-size: 13px;">
                    ...
                    <td><img src="../../images/sponsors/<?php echo $res['image'] ?>" style="height: 70px;"></td>
                    <td>

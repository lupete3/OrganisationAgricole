    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Liste des agents déjà affectés</li>
        </ol>
        <div class="row">
          <div class="col-md-12">
                 <?php 
       ...
       <div class="card mb-3">
          <div class="card-header">
            ...
            Liste des agents déjà affectés <h4 class="float-right"><a href="ficheAgentsAffect.php" target="blank" class="btn btn-sm btn-success" title=""><i class="fa fa-print"></i> Imprimer la fiche</a></button> </h4></div>
          <div class="card-body">
            <div class="table-responsive">
              ...
              <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php $obs = 'affecté'; 
                    $req=$bd->prepare("SELECT A.noms, B.id, B.dateAffectation, B.dateDebut, B.dateFin, C.designation, C.activite FROM agent AS A,affectation AS B, maison AS C WHERE B.idAgent = A.id AND B.idMaison = C.id AND B.observation = ? ");
                   ...
                   <tr>
                    ...
                    <td><?php echo $res['dateAffectation'] ?></td>
                    <td><?php echo $res['dateDebut'] ?></td>
                    <td><?php echo $res['dateFin'] ?></td>
                    <td><?php echo $res['designation'] ?></td>
                    <td><?php echo $res['activite'] ?></td>
                    <td>
                      
                      <button class="btn btn-danger btn-sm editBtn"><i class="fa fa-trash" title="SDésaffecter l'agent"></i> Désaffecter</button>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
  ...
  <div class="modal fade" id="editBtn" tabindex="-1" role="dialog" aria-labelledby="Modregister" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content panel-primary">
        ...
        <form action="../access/finAffectation.php" method="POST" was-validate>
          <input type="hidden" name="id" id="id" class="form-control" placeholder="Id" required="required" >

          <div class="form-group">
            <div class="form-row">
              <div class="col-md-12 text-center">
                <h4>Etes-vous sûr de vouloir désaffecter cet agent ?</h4>
              </div>
            </div>
          </div>

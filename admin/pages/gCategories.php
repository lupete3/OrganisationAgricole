  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <form action="../access/register_categorie.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="card-body">
          ...
          <div class="form-group">
            <div class="form-row">
                 ...
                 <?php 
                   if (isset($_GET['sms']) AND $_GET['sms'] == 2){ ?>
                    <div class="alert alert-success alert-dismissible" id="msg" role="alert">
                            ...
                            <h6>Catégorie ajoutée avec succès</h6>
                          </div>
              ...
              <div class="col-md-12">
                <input type="text" id="firstName" name="titre" class="form-control" placeholder="Nom catégorie" required="required" autocomplete="off"><br>
              </div>

              <div class="col-md-12">
                <button type="submit" name="save" class="btn btn-sm btn-success "><i class="fa fa-check-circle"></i> Enregistrer </button>
          <a href="listCategories.php" title=""><button type="button" class="btn btn-sm btn-secondary "><i class="fa fa-list"></i> Liste des catégories</button></a>
              </div>

       ...
       <div class="card mb-3">
          <div class="card-header">
            ...
            Liste des catégories <div class="float-right">
               <a href="gCategories.php" class="btn btn-success btn-sm "><i class="fa fa-plus-circle"></i> Ajouter une nouvelle catégorie</a>
            </div>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php 
                    $req=$bd->prepare("SELECT * FROM categorie ORDER BY libelle ASC");
                    $req->execute();
                    $i = 1;
                    while ($res = $req->fetch()) { ?>
    ...
    <div class="modal fade" id="editBtn" tabindex="-1" role="dialog" aria-labelledby="Modregister" aria-hidden="true">
      ...
      <div class="modal-content panel-primary">
        <div class="modal-header">
          <h4 class="modal-title" id="AddSectionLabel">Modification Catégorie</h4>
          <button type="button" class="close btn " data-dismiss="modal" aria-hidden="true">&times;</button>
                        
        </div>
        <div class="modal-body">
        <form action="../access/edit_categorie.php" method="post" was-validate>
          <input type="text" name="id" id="id" class="form-control" placeholder="Id" required="required" >
          <div class="form-row">
              <div class="col-md-12">
                <label for="nom">Catégorie</label>
                <input type="text" id="nom" name="libelle" class="form-control" placeholder="Catégorie" required="required" autofocus="autofocus"> <br>
              </div>

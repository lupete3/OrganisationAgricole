  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <form action="../access/register_membre.php" method="POST" enctype="multipart/form-data">
       
        <!-- DataTables Example -->
       <div class="card card-register mx-auto mt-5">
      <div class="card-header text-uppercase">Ajouter un membre</div>
      <div class="card-body">
          ...
          <div class="form-group">
            <div class="form-row">
                 ...
                 <?php 
                   if (isset($_GET['sms']) AND $_GET['sms'] == 2){ ?>
                    <div class="alert alert-success alert-dismissible" id="msg" role="alert">
                            ...
                            <h6>Membre ajouté avec succès</h6>
                          </div>
              ...
              <div class="col-md-12">
                <input type="text" id="firstName" name="titre" class="form-control" placeholder="Nom complet" required="required" autocomplete="off"><br>
              </div>
              
              <div class="col-md-12">
                <input type="text" id="firstName" name="fonction" class="form-control" placeholder="Fonction" required="required" autocomplete="off"><br>
              </div>
              <div class="col-md-12">
          ...
          <a href="listMembres.php" title=""><button type="button" class="btn btn-sm btn-secondary "><i class="fa fa-list"></i> Liste des membres</button></a>
              </div>

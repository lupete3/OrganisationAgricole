<?php 
  ...
  require_once ('../access/connex.php'); 
    ...
    if(isset($_GET['id'])){
      ...
      $req=$bd->prepare('UPDATE email_box SET statut = ? WHERE id = ?');

      if ($req->execute(array('lu',$id))){
    ...
    <div id="content-wrapper" class="container-fluid">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Boite de Reception</li>
        </ol>
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php 
                    $req=$bd->prepare("SELECT * FROM email_box ORDER BY datePub DESC");
                    $req->execute();
                    $i = 1;
                    while ($res = $req->fetch()) { ?>
                  ...
                  <tr style="font-size: 13px;">
                    ...
                    <td>
                    <a href="?id=<?php echo $res['id'] ?>" title=""><?php echo (($res['statut'] == 'nouveau')?'<button type="button" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> Marquer comme lu</button>' : ''); ?></a>
                  </td>
                  </tr>
                  <?php $i++; } ?>
                </tbody>

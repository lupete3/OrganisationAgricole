    ...
    <div id="content-wrapper" class="container-fluid">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Liste Services</li>
        </ol>
       ...
       <div class="card mb-3">
          <div class="card-header">
            ...
            Liste des catégories <div class="float-right">
               <a href="gServices.php" class="btn btn-success btn-sm"><i class="fa fa-plus-circle"></i> Ajouter un service</a>
            </div>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php 
                    $req=$bd->prepare("SELECT * FROM service ");
                    $req->execute();
                    $i = 1;
                    while ($res = $req->fetch()) { ?>
        ...
        <div class="modal-dialog">
          <div class="modal-content panel-primary">
            <div class="modal-header">
              <h4 class="modal-title" id="AddSectionLabel">Modification Service</h4>
              <button type="button" class="close btn " data-dismiss="modal" aria-hidden="true">&times;</button>
                            
            </div>
            <div class="modal-body">
            <form action="../access/edit_service.php" method="post" was-validate>
              <input type="hidden" name="id" id="id" class="form-control" placeholder="Id" required="required" >
              <div class="form-row">
                  <div class="col-md-12">
                    <label for="nom">Désignation Service</label>
                    <input type="text" id="titre" name="titre" class="form-control" placeholder="Désignation Service" required="required" autofocus="autofocus"> <br>
                  </div>
                  <div class="col-md-12">
                    <label for="nom">Rôle Service</label>
                    <input type="text" id="nom" name="detail" class="form-control" placeholder="Rôle Service" required="required" autofocus="autofocus"> <br>
                  </div>
  ...
  <!-- /.modal-content -->
    ...
    <div class="modal fade" id="supBtn" tabindex="-1" role="dialog" aria-labelledby="Modregister" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content panel-primary">
            <div class="modal-header">
              <h4 class="modal-title" id="AddSectionLabel">Suppression Service</h4>
              <button type="button" class="close btn " data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <form action="../access/edit_service.php" method="post" was-validate>
              ...
              <div class="form-row">
                  ...
                  <div class="col-md-12 text-center">
                    <h5>Voulez-vous vraiment supprimer ce service ?</h5> <br>
                  </div>
